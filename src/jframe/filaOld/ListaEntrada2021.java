 ...
 * @author Gustavo
 */
public final class ListaEntrada2021 extends javax.swing.JFrame {

    date date = new date();
    String user = System.getProperty("user.name");
    File fichero2 = new File("C:\\Users\\" + user + "\\Documents\\NetBeansProjects\\JFrame\\src\\file\\entrada.csv");
    File fichero = new File("C:\\Users\\" + user + "\\Documents\\NetBeansProjects\\JFrame\\src\\file\\Horarios_26-12-2020_31-12-2021.csv");
    File fichero_temporal = new File("C:\\Users\\" + user + "\\Documents\\NetBeansProjects\\JFrame\\src\\file\\temporal.csv");
    File ficheroEntradaSalida = new File("C:\\Users\\" + user + "\\Desktop\\Fichero_Entrada_Salida_Horarios_26-12-2020_31-12-2021.csv");

    /**
     * Creates new form ListaEntradaSalida
     */
    public ListaEntrada2021() {
        MiRenderer m = new MiRenderer();
        initComponents();
        ficheroApp();
        this.setTitle("Registros Control Usuarios");
        this.setLocationRelativeTo(ListaEntrada2021.this);
